                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="{{ url('resume/details/'.$items->id) }}">{{ $items->name }} <span>{{ $items->job_title }}</span></a>
                                        </h2>
                                    </td>
                                    <td><a href="{{ url('job/details/resume/'.$items->id) }}">{{ $items->job_title }}</a></td>
                                    ...
                                    <td><a href="{{ url('cv/download/'.$items->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-download mr-1"></i> Download</a></td>
                                    <td class="text-center">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a href="#" class="dropdown-item delete_job" data-toggle="modal" data-target="#delete_job" data-job-id="{{ $items->id }}"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form id="delete_job_form" method="POST" action="{{ route('form/apply/resume/delete') }}">
                    @csrf
