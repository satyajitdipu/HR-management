...
@section('content')
                ...
                <div class="col-lg-8 col-md-8">
                    ...
                    <section class="dash-section">
                        ...
                        <div class="dash-sec-content">
                            ...
                            <div class="dash-info-list">
                                <a href="{{ route('form/holidays/new') }}" class="dash-card">
                                    <div class="dash-card-container">
                                        <div class="dash-card-icon">
                                ...
                                <div class="card-body">
                                    <div class="time-list">
                                        <div class="dash-stats-list">
                                            <h4>{{count($totaltask)}}</h4>
                                            <p>Total Tasks</p>
                                        </div>
                                        <div class="dash-stats-list">
                                            <h4>{{count($totaltask->where('task_status','Completed Tasks'))}}</h4>
                                            <p>Pending Tasks</p>
                                        </div>
                                    </div>
                                    <div class="request-btn">
                                        <div class="dash-stats-list">
                                            <h4>{{count($totalproject)}}</h4>
                                            <p>Total Projects</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="time-list">
                                        ...
                                        <div class="dash-stats-list">
                                            <h4>{{12-count($leave)}}</h4>
                                            <p>Remaining</p>
                                        </div>
                                    </div>
                                    <div class="request-btn">
                                    <a class="btn btn-primary" href="{{ route('form/leavesemployee/new') }}">Apply Leave</a>                                    </div>
                                </div>
                            </div>
                        </section>
    ...
    <h4 class="holiday-title mb-0"> {{$holiday->first()->date_holiday.' ' .$holiday->first()->name_holiday}}</h4>
@else
