            ...
            <ul>
                ...
                <li class="{{set_active(['form/expense/reports/page','form/invoice/reports/page','form/leave/reports/page','form/daily/reports/page','form/payments/reports/page','form/employee/reports/page'])}} submenu">
                    ...
                    <ul style="{{ request()->is('/*') ? 'display: block;' : 'display: none;' }}">
                        ...
                        <li><a class="{{set_active([''])}}" href="{{route('form/salary/page')}}"> Payslip Report </a></li>
                        <li><a class="{{set_active([''])}}" href="{{route('attendance/page')}}"> Attendance Report </a></li>
...
@endif
                        ...
                        <li><a class="{{set_active(['user/job/status'])}}" href="{{ route('user/job/status') }}">Apply job status </a></li>
                        <li><a class="{{set_active(['page/offer/approvals'])}}" href="{{ route('page/offer/approvals') }}"> Offer Approvals </a></li>
                        <li><a class="{{set_active(['form/job/all'])}}" href="{{ route('form/job/all') }}"> Apply jobs </a></li>
