...
@section('content')
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item delete-holiday" href="#" data-toggle="modal" data-id="{{ $items->id }}" data-target="#delete_holiday"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="deleteForm" method="POST" action="{{ route('form/holidays/delete') }}">
                @csrf
                <input type="hidden" name="holiday_id" id="deleteHolidayId">
                <div class="modal-body">
                <input type="hidden" id="deleteHolidayId" name="deleteHolidayId">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        Livewire.on('holidayAdded', function () {
