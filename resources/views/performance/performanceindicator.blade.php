...
@section('content')
    ...
    <a id="statusDropdown" class="btn btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
        <i class="fa fa-dot-circle-o text-{{ $performance->status === 'active' ? 'success' : 'danger' }}"></i> {{ ucfirst($performance->status) }}
    </a>
    <div class="dropdown-menu">
        <a class="dropdown-item" href="#" onclick="setStatus('active'); return false;"><i class="fa fa-dot-circle-o text-success"></i> Active</a>
        <a class="dropdown-item" href="#" onclick="setStatus('inactive'); return false;"><i class="fa fa-dot-circle-o text-danger"></i> Inactive</a>
    </div>
</div>



    <form id="statusForm" action="{{ route('form/update/indicatoractivestatus') }}" method="POST" style="display: none;">
        @csrf
 ...
 <script>
    function setStatus(status) {
        var id = 1; // Set the ID value here
