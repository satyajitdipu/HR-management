                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('category') is-invalid @enderror" type="text" name="category" required>
                                    </div>
                                </div>
                            </div>
...
<!-- Add this pattern for Correct Answer -->
<div class="col-md-12">
    <div class="form-group">
        ...
        <select class="select @error('answer') is-invalid @enderror" name="answer">
            ...
            <option value="{{ $ans->answer }}" {{ old('answer') == $ans->answer ? "selected" : "" }}>{{ $ans->answer }}</option>
            @endforeach
        </select>
        @error('answer')
        <span class="invalid-feedback">{{ $message }}</span>
