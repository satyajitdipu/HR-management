...
@section('content')
    ...
    <div class="dropdown action-label">
        ...
        <form id="update_job_type_form_{{ $items->id }}" action="{{ route('form/apply/job/type/update', ['id' => $items->id]) }}" method="POST" style="display: none;">
            @csrf
            <input type="hidden" name="job_type" value="">
        </form>
        <div class="dropdown-menu dropdown-menu-right jobtype_status">
            <a class="dropdown-item" href="#" onclick="updateJobType('Full Time', {{ $items->id }})"><i class="fa fa-dot-circle-o text-info"></i> Full Time</a>
            <a class="dropdown-item" href="#" onclick="updateJobType('Part Time', {{ $items->id }})"><i class="fa fa-dot-circle-o text-success"></i> Part Time</a>
            <a class="dropdown-item" href="#" onclick="updateJobType('Internship', {{ $items->id }})"><i class="fa fa-dot-circle-o text-danger"></i> Internship</a>
            <a class="dropdown-item" href="#" onclick="updateJobType('Temporary', {{ $items->id }})"><i class="fa fa-dot-circle-o text-warning"></i> Temporary</a>
            <a class="dropdown-item" href="#" onclick="updateJobType('Remote', {{ $items->id }})"><i class="fa fa-dot-circle-o text-dark"></i> Remote</a>
            <a class="dropdown-item" href="#" onclick="updateJobType('Others', {{ $items->id }})"><i class="fa fa-dot-circle-o text-dark"></i> Others</a>
        </div>
    </div>
</td>
<td class="text-center">
    <div class="dropdown action-label">
        ...
        <div class="dropdown-menu dropdown-menu-right">
            <a class="dropdown-item" href="#" onclick="updateStatus('{{ $items->id }}', 'Open')">Open</a>
            <a class="dropdown-item" href="#" onclick="updateStatus('{{ $items->id }}', 'Closed')">Closed</a>
            <a class="dropdown-item" href="#" onclick="updateStatus('{{ $items->id }}', 'Cancelled')">Cancelled</a>
        </div>
        <form id="status_form_{{ $items->id }}" action="{{ route('form/apply/job/type/update') }}" method="POST" style="display: none;">
            @csrf
            <input type="hidden" name="job_id" value="{{ $items->id }}">
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a href="#" class="dropdown-item" data-toggle="modal" data-target="#delete_job" data-job-id="{{ $items->id }}"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="add_job_form" action="{{ route('form/jobs/save') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form id="delete_job_form" method="POST" action="{{ route('form/apply/job/delete') }}">
                    @csrf
...
<script>
    function updateJobType(jobType, id) {
        document.querySelector('#update_job_type_form_' + id + ' input[name="job_type"]').value = jobType;
        document.querySelector('#update_job_type_form_' + id).submit();
    }
    function updateStatus(jobId, status) {
        var form = document.getElementById('status_form_' + jobId);
