...
class TrainingTypeController extends Controller
{
    ...
    public function updatedtypetraing(Request $request){
        
        $traingtype=TrainingType::find($request->item_id);
        $traingtype->status=$request->status;
        $traingtype->save();
        Toastr::success('Training type updated status successfully :)','Success');
            return redirect()->back();
