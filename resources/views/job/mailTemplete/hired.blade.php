...
<head>
    ...
    <title>You are Hired For Job</title>
    <style>
        /* Reset CSS */
        body, html {
            margin: 0;
...
<div class="email-content">
    ...
    <p>Congratulations! We are pleased to inform you that you have been hired for the position of {{$status->job_title}}. Welcome to our team!</p>
