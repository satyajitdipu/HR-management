...
class PerformanceController extends Controller
{
    ...
    public function indicatoractivestatus(Request $request){
        $performance=performanceIndicator::find($request->id);
        $performance->status=$request->status;
        $performance->save();
        Toastr::success('Performance indicator status update successfully :)','Success');
        return redirect()->back();
    ...
    public function appraisalactivestatus(Request $request){
      
        $appersal=performance_appraisal::find($request->id);
        $appersal->status=$request->status;
        $appersal->save();
        Toastr::success('performance appraisal status update successfully :)','Success');
        return redirect()->back();
    }
    /** delete record */
